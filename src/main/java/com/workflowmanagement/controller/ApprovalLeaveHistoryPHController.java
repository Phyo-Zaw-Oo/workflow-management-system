...
@Controller
public class ApprovalLeaveHistoryPHController {
	...
	@RequestMapping(value = "/leaveApprovalPHView", method = RequestMethod.GET)
	public ModelAndView approvalHistorySetUp(ModelMap model) {
		 ...
		 */
		return new ModelAndView("WFMS-PAL-002", "leaveForm", new LeaveFormBean());
	}

	@RequestMapping(value = "/approvalHistoryPH", method = RequestMethod.POST)
	public ModelAndView searchLeave(@ModelAttribute("leaveForm") LeaveFormBean bean, ModelMap model) {
		...
		return new ModelAndView("WFMS-PAL-002", "leaveStatusList", leaveStatusList);
	}
