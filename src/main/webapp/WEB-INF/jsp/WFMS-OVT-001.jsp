  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add Overtime Type</h1>
          </div>
        </div>
      </div>
    </div>
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <form:form class="register-form" action="addOvertimeType" method="post" modelAttribute="overtimeType">
                <div class="card-body">
                  <div class="form-group">
                 
                    <label for="exampleInputLeave1">Overtime Type ID</label>
                    <div class="col-lg-6 col-md-12 pl-0">
                      <form:input type="text" class="form-control" value="${otTypeId}" path="overtimeTypeId" required="required"></form:input>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputLeave1">Overtime Type</label>
                    <div class="col-lg-6 col-md-12 pl-0">
                      <form:input type="text" class="form-control" required="required" path="overtimeType" placeholder="Enter Name"></form:input>
                    </div>
                  </div>
                <div class="card-footer">
                  <a href="WFMS-OVT-002.jsp" class="btn btn-default" style="margin-left: 370px;">Cancel</a>
