...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<a href="WFMS-ADH-002.html" class="brand-link"> <img
			...
			<ul class="nav nav-pills nav-sidebar flex-column"
				...
				<li class="nav-item has-treeview"><a href=""
					class="nav-link"> <i class="nav-icon fas fa-tasks"></i>
						<p>
							Manage Department <i class="fas fa-angle-left right"></i>
						</p>
				</a>
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="addDeptSetUp" class="nav-link">
								<i class="nav-icon far fa-plus-square"></i>
								<p>Add Department</p>
						</a></li>
						<li class="nav-item"><a href="deptListSetUp" class="nav-link">
								<i class="nav-icon far fa-plus-square"></i>
				...
				<li class="nav-item has-treeview"><a href="#" class="nav-link">
						...
						<p>
							Manage User <i class="fas fa-angle-left right"></i>
						</p>
				</a>
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="addUserSetup"
							class="nav-link"> <i class="nav-icon far fa-plus-square"></i>
								<p>Add User</p>
						</a></li>
						<li class="nav-item"><a href="searchUserSetup"
							class="nav-link"> <i class="nav-icon far fa-plus-square"></i>
								<p>User Lists</p>
						</a></li>
					</ul></li>
				<li class="nav-item has-treeview"><a href=""
					class="nav-link"> <i class="nav-icon fas fa-tasks"></i>
						<p>
							Manage Leave Type <i class="fas fa-angle-left right"></i>
						</p>
				</a>
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="setup_add_leavetype"
							class="nav-link"> <i class="nav-icon far fa-plus-square"></i>
								<p>Add Leave Type</p>
						</a></li>
						<li class="nav-item"><a href="leaveType_list_setup"
							class="nav-link"> <i class="nav-icon far fa-plus-square"></i>
								<p>Leave Type Lists</p>
						</a></li>
					</ul></li>
				<li class="nav-item has-treeview"><a href=""
					class="nav-link"> <i class="nav-icon fas fa-tasks"></i>
						<p>
							Manage Overtime Type <i class="fas fa-angle-left right"></i>
						</p>
				</a>
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="addOvertimeTypeSetUp"
							class="nav-link"> <i class="nav-icon far fa-plus-square"></i>
								<p>Add Overtime Type</p>
						</a></li>
						<li class="nav-item"><a href="overtimeTypeListSetUp"
							class="nav-link"> <i class="nav-icon far fa-plus-square"></i>
								<p>Overtime Type Lists</p>
						</a></li>
					</ul></li>
