...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<a href="WFMS-HRH-002.html" class="brand-link"> <img
		...
		<div class="sidebar">
			...
			<ul class="nav nav-pills nav-sidebar flex-column"
				...
				<li class="nav-item"><a href="showLeaveApprovalWaiting"
				...
				<li class="nav-item"><a href="checkStatus"
					class="nav-link"> <i class="nav-icon far fa-edit"></i>
						<p class="text">In Progress Application</p>
				</a></li>
				...
				<li class="nav-item has-treeview"><a href=""
					class="nav-link"> <i class="nav-icon far fa-edit"></i>
						<p>
							Staff History <i class="fas fa-angle-left right"></i>
						</p>
				</a>
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="checkStaffLeaveSetup"
							class="nav-link"> <i class="nav-icon far fa-plus-square"></i>
								<p>Leave</p>
						</a></li>
						<li class="nav-item"><a href="checkStaffOtSetup"
							class="nav-link"> <i class="nav-icon far fa-plus-square"></i>
								<p>Overtime</p>
						</a></li>
					</ul></li>
				<li class="nav-item has-treeview"><a href=""
					class="nav-link"> <i class="nav-icon far fa-edit"></i>
						<p>
							Approval History <i class="fas fa-angle-left right"></i>
						</p>
				</a>
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="leaveApprovalHRView"
							class="nav-link"> <i class="nav-icon far fa-plus-square"></i>
								<p>Leave</p>
						</a></li>
						<li class="nav-item"><a href="overtimeApprovalPHView"
							class="nav-link"> <i class="nav-icon far fa-plus-square"></i>
								<p>Overtime</p>
						</a></li>
					</ul></li>
