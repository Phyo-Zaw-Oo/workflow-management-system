		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="card">
						<form:form class="form" action="/approveCompleteForm" id="approvedComplete"
							modelAttribute="id">
							<div class="card-body">
				...
				<div class="modal-footer">
					...
					<button onclick="approvedComplete_form_submit()" class="btn btn-sm btn-primary"
	...
	<div id="sendBackModal" class="modal fade" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button onclick="sendback_form_submit()" class="btn btn-sm btn-primary"
	...
	<div id="rejectModal" class="modal fade" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button onclick="reject_form_submit()" class="btn btn-sm btn-primary"
						data-dismiss="modal">Submit</button>
				</div>
			</div>
		</div>
