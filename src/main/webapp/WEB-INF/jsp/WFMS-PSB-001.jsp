...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<a href="WFMS-PMH-002.html" class="brand-link"> <img
		...
		<div class="sidebar">
			...
			<ul class="nav nav-pills nav-sidebar flex-column"
				...
				<li class="nav-item"><a href="showLeaveApprovalWaitingForHODAndPM"
				...
				<li class="nav-item has-treeview"><a href=""
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="leaveApprovalPHView"
							class="nav-link"> <i class="nav-icon far fa-plus-square"></i>
								<p>Leave</p>
						</a></li>
			...
			<div class="modal-content">
				<form:form action="/changePassword" id="update_password">
					...
					<div class="modal-footer">
						<button onclick="update_form_submit()" class="btn btn-sm btn-primary"
