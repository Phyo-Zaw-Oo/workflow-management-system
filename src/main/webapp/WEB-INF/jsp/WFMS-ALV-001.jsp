	...
	<c:choose>
		...
		<div class="content-wrapper">
			...
			<label id="message" style="color: red;" margin="left">${err}</label>
							<form:form class="apply-form" action="addLeaveForm" method="post"
								modelAttribute="leaveForm">
								<div class="card-body">
									<div class="form-group">
										<form:input type="hidden" path="leaveForm" value="${leaveForm.leaveForm}"/>
										<label for="exampleInputLeave1">Leave Type</label>
										<div class="col-lg-6 col-md-12 pl-0">
											<form:select path="leaveType" class="form-control" required="required">
											<form:option value="">--Select--</form:option>
												<form:options items="${leaveList}" itemLabel="leaveType"
									...
									<div class="form-group">
										...
										<div class="col-lg-6 col-md-12 pl-0">
											<div class="form-check  form-check-inline">
												<form:radiobutton path="fullOrHalf" class="form-check-input"
													id="exampleCheck2" value="1" checked="checked"></form:radiobutton>
												<label class="form-check-label" for="exampleCheck2">Full</label>
											</div>
											<div class="form-check  form-check-inline">
												<form:radiobutton path="fullOrHalf" class="form-check-input"
													id="exampleCheck2" value="0.5"></form:radiobutton>
									...
									<div class="form-group">
										...
										<div class="input-group col-lg-6 col-md-12 pl-0">
												...
												<form:input type="text"
													...
													path="dateRange" autocomplete="off" required="required"></form:input>
											</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-6 col-md-12 pl-0">
											<form:select path="assignTo" class="form-control" required="required">
											<form:option value="">--Select--</form:option>
									...
									<div class="form-group">
										...
										<div class="col-lg-6 col-md-12 pl-0">
											<form:select path="submitTo" class="form-control" required="required">
											<form:option value="">--Select--</form:option>
												<form:options items="${submitToUser}" itemLabel="name"
													itemValue="userId" />
											</form:select>
										</div>
									</div>
