    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <form:form class="register-form" action="addDept" method="post" modelAttribute="department">
                <div class="card-body">
                  <div class="form-group">
                  
                    <label for="exampleInputLeave1">Department ID</label>
                    <div class="col-lg-6 col-md-12 pl-0">
                      <form:input type="text" class="form-control" value="${depId}" path="departmentId" required="required"></form:input>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputLeave1">Name</label>
                    <div class="col-lg-6 col-md-12 pl-0">
                      <form:input type="text" class="form-control" path="departmentName" required="required" ></form:input>
                    </div>
                  </div>
                <div class="card-footer">
                  <a href="WFMS-DEP-002.jsp" class="btn btn-default" style="margin-left: 370px;">Cancel</a>
