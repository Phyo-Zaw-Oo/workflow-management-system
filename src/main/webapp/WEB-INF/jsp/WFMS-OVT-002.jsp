	...
	<div class="content-wrapper">
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0">Overtime Type List</h1>
					</div>
				</div>
			</div>
		</div>
		<div class="search-form content"
			...
			<form:form action="/overtimeTypeList" method="post"
				modelAttribute="overtimeType">
				<div class="row">
					<div class="col-2">
						<div class="form-group">
							<label for="exampleInputEmail1">Overtime Type ID</label>
					...
					<div class="col-2">
						<div class="form-group">
							...
							<form:input type="text" class="form-control"
								id="exampleInputEmail1" placeholder="Enter Overtime Type"
								path="overtimeType" />
						</div>
					</div>
					<div class="col-2">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12">
					<div class="card">
					<c:if test="${overtimeList!=null}">
						<div class="card-header">
							<h3 class="card-title">Overtime Type List</h3>
						</div>
						<div class="card-body">
							<table  class="table table-bordered">
								...
								<tbody>
									<c:forEach items="${overtimeList}" var="list">
										<tr>
											<td>${list.overtimeTypeId}</td>
											<td>${list.overtimeType}</td>
											<td><a
												href="/updateOvertimeTypeSetUp?id=${list.overtimeTypeId}">
													<input type="button" value="Edit" id="Edit"
													class="btn btn-sm btn-primary" id="LeaveTypeUpdate" />
											</a> <a href="/deleteOvertimeType?id=${list.overtimeTypeId}">
