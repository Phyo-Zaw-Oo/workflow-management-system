    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <form:form class="register-form" action="/add_leavetype" method="post" modelAttribute="leaveType">
                <div class="card-body">
                  <div class="form-group">
                  <label id="message" style="color: red;">${err}</label>
                  <label id="message" style="color: Green;" >${msg}</label>
                    <label for="exampleInputLeave1">Leave Type ID</label>
                    <div class="col-lg-6 col-md-12 pl-0">
                      <form:input type="text" class="form-control" value="${lvTypeId}" path="leaveTypeId" required="required"></form:input>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputLeave1">Leave Type</label>
                    <div class="col-lg-6 col-md-12 pl-0">
                      <form:input type="text" class="form-control" path="leaveType" required="required" placeholder="Enter Leave Name"></form:input>
                    </div>
                  </div>
                <div class="card-footer">
                  <a href="WFMS-LEV-002.jsp" class="btn btn-default" style="margin-left: 370px;">Cancel</a>
