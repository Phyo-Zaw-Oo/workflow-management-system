        ...
        <div class="row">
          <div class="col-12">
			...
			<label id="message" style="color: red;" margin="left">${err}</label>
              <form:form class="apply-form" action="addOvertimeForm" method="post" modelAttribute="otForm">
                <div class="card-body">
                  <div class="form-group">
                  	<form:input type="hidden" path="overtimeForm" value="${otForm.overtimeForm}"></form:input>
                    <label for="exampleInputLeave1">Overtime Type</label>
                    <div class="col-lg-6 col-md-12 pl-0">
                      <form:select path="overtimeType" class="form-control" id="exampleInputLeave1"
                      itemValue="otTypeId" itemLabel="otType" required="required">
                      <form:option value="">--Select--</form:option>
                       <form:options items="${otTypeList}" itemValue="overtimeTypeId"
						itemLabel="overtimeType"/>
                      </form:select>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group col-lg-6 col-md-12 pl-0">
                      ...
                      <form:input type="text" class="form-control float-right date-time-range" 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-6 col-md-12 pl-0">
                      <form:select class="form-control" path="submitTo" items="${userList}"
                      itemValue="userId" itemLabel="name" required="required">
