						...
						<div class="col-2">
							<div class="form-group">
								...
								<form:input type="text" class="form-control"
									id="exampleInputEmail1" path="userId" placeholder="Enter ID"></form:input>
							</div>
						</div>
						<div class="col-2">
							<div class="form-group">
								...
								<form:input type="text" class="form-control"
									id="exampleInputEmail1" path="userName"
									...
									<tbody>
										<c:forEach items="${userList}" var="list">
											<tr>
												...
												<td><a href="updateUserSetup?id=${list.userId}"> <input
														type="button" value="Edit" class="btn btn-sm btn-primary"
														id="deptUpdate" />
												</a> <a href="deleteUser?id=${list.userId}"> <input
